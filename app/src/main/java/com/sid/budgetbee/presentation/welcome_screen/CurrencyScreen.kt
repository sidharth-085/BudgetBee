...
import com.sid.budgetbee.presentation.ui.theme.Manrope
                            ...
                            Row(
                                ...
                                TextButton(
                                    ...
                                    colors = ButtonDefaults.buttonColors(
                                        backgroundColor =
                                        if (selectedCountry == currency) MaterialTheme.colors.primary
                                        else Color.DarkGray.copy(alpha = 0.1f),
                                        contentColor =
                                        if (selectedCountry == currency) contentColorFor(backgroundColor = MaterialTheme.colors.primary)
